...
# RPM 4.15.0 RC1 Release Notes (DRAFT)


## Download information
 * [rpm-4.15.0-rc1.tar.bz2](http://ftp.rpm.org/releases/testing/rpm-4.15.0-rc1.tar.bz2)
 * SHA256SUM: ``cd5e3869356a3fe8b04df2e9f5c54ea17258b0aff2caa6d8a56a6748aa2d5463
 ...
 * Fix --reinstall --replacepkgs failing on the erase element
 ...
 * Optimize several operations via thread parallelization up to
   %_smp_build_ncpus (but limited to maximum of 4 on 32bit platforms)
   * file classification
