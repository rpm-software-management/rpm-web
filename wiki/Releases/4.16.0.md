...
# RPM 4.16.0 BETA1 Release Notes (DRAFT)

## Download information
 * Source: [rpm-4.16.0-beta1.tar.bz2](http://ftp.rpm.org/releases/testing/rpm-4.16.0-beta1.tar.bz2)
 * SHA256SUM: 53bd332daf9605cc6d387691965f7cf455ab2b5556387b9fc40d7ca1b6457115
...
* Add native support for version comparison in expressions via v"..." strings
  (eg `%if v"%{python_version}" < v"3.9"` but also cli and arbitrary macros
   `%[v"1:1.2" < v"2.0"]`)
